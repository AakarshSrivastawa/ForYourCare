...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="#g3">Contact Us</a>
                    <a href="Login1.php"><button type="button" class="btn btn-dark">Login</button></a>
                    <a href="Sign-Up.html"><button type="button" class="btn btn-warning">Sign-Up</button></a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="content">
        ...
        <section id="contact">
            <form class="row g-3 needs-validation" id="ous" novalidate>
                ...
                <div class="col-sm-4">
                    <button class="btn btn-primary" type="submit">Please Contact Me</button>
                </div>
                <p> *We will contact you shortly to confirm an appointment
                    time convenient to your schedule.</p>
                                      <?php
...
?>
    ...
    <section id="cont">
        ...
        <div class="row">
            <div class="col-sm-4">
                <form class="transbox" method="get" action="About Ous.html">

                    <img src="stethoscope.png" alt="" class="set"><br><br>
                    ...
                    <select class="form-select" aria-label="Default select example" name="select_type">
                        ...
                        <option value="Gynecologist (OBGYN)" name="Gynecologist (OBGYN)">Gynecologist (OBGYN)</option>
                        <option value="Orthopedic Surgeon" name="Orthopedic Surgeon">Orthopedic Surgeon</option>
                        <option value="Dermatologist" name="Dermatologist">Dermatologist</option>
                        <option value="Psychologist" name="Psychologist">Psychologist</option>
                        <option value="General Surgeon" name="General Surgeon">General Surgeon</option>
                        <option value="Ear Nose and Throat Doctor (ENT)" name="Ear Nose and Throat Doctor (ENT)">Ear
            ...
            <div class="col-sm-4">
                <form class="appiont">
                    ...
                    <button class="get">Get Appointment</button><br>
                    <a href="About Us">View All Our Location</a><br><br>
                </form>
            </div>
            <div class="col-sm-4">
                <form class="clinical">
                    ...
                    <button>Get Clinical Tests</button>
                </form>
            </div>
    ...
    <footer class="row " id="fot">
        ...
        <div class="col-sm-4">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="About Ous.html" class="nav-link p-0 text-muted">About Ous</a>
                </li>
            </ul>
        </div>
        <form class="link">
